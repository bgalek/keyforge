...
class MetadataKeyForgeTest {
    ...
    @Test
    @DisplayName("Should ignore duplicated keys")
    void shouldParseProvidedKey2() {
        MetadataKeyForge keyForge = new MetadataKeyForge();
        MetadataApiKey apiKey = keyForge.parse("sk_QmFydD1TaW1wc29uJkJhcnQ9U2ltcHNvbg");
        assertEquals(apiKey.getMetadata(), Map.of("Bart", "Simpson"));
    }
    ...
    void simplestCase() {
        MetadataKeyForge keyForge = new MetadataKeyForge();
        MetadataApiKey apiKey = keyForge.generateKey()
